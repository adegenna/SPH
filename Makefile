...
objs_sph = sph.o particle.o fluid.o initialize.o incompinvisc.o incompvisc.o splinekernel.o gaussiankernel.o predictorcorrector.o eulermod.o euler.o output.o
